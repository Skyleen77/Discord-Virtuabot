...
module.exports = new Command({
    ...
    async run(bot, message, args, db) {
        ...
        if(user.id === developper) return message.reply("Vous ne pouvez pas ban mon créateur");
        ...
        if(message.user) {
            ...
            await message.reply({content: `${user.tag} a été banni par ${message.user === undefined ? message.author.tag : message.user.tag} pour la raison ${reason} avec succès !`, components: [btn]})

            await message.fetchReply().then(async msg => {
